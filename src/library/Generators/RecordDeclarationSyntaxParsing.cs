...
internal static class RecordDeclarationSyntaxParsing
{
  internal static string GetRecordName(RecordDeclarationSyntax classDeclaration)
  {
    return classDeclaration.Identifier.ToString();
  }

  internal static string GetNamespaceName(RecordDeclarationSyntax classDeclaration)
  {
