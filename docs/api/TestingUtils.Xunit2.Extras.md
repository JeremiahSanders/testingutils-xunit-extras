...
## Jds.TestingUtils.Xunit2.Extras.Generators namespace

| public type | description |
| --- | --- |
| class [SharedCaseContextGenerator](./Jds.TestingUtils.Xunit2.Extras.Generators/SharedCaseContextGenerator.md) | A source generator which produces a base test case arrangement fixture, a base "assertion"/"test" class, and an implementation of ICollectionFixture (required for xUnit). |
